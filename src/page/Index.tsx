...
export default function IndexPage() {
  return (
    ...
    >
      ...
      <div className="flex flex-col p-1 m-1 divide-y divide-gray-500">
        <div className="flex flex-row divide-x divide-gray-100 p-1 m-2">
          ...
          <div className="flex flex-col w-1/3 bg-slate-200 rounded-r">
            <div className="flex flex-row items-center">
              <div className="flex flex-row w-2/3 bg-sky-300 text-gray-700 rounded-r-lg p-3 m-6 h-10 items-center">
                ...
                <div className="text-xl p-2 m-2">斗士 Fighter</div>
              </div>
              <div className="items-center w-24 bg-gray-400 rounded-full p-3 m-3 h-10 text-center text-sm text-gray-50">
                已订阅
              </div>
            </div>
        ...
        <div className="flex flex-row-2 divide-x divide-gray-300 p-2 m-2">
          ...
          <div className="flex flex-col w-1/3 bg-slate-200 rounded-r">
            <div className="flex flex-row items-center">
              ...
              <div className="flex flex-row items-center w-24 bg-orange-400 rounded-full p-3 m-3 h-10 text-center text-sm text-gray-50 hover:bg-orange-600">
                <div className="w-6">
                  <BsPlus />
                </div>
                <div className="text-center">订阅</div>
              </div>
            </div>
            <div className="w-4/5 text-gray-700 m-4 p-4">一款角色扮演游戏</div>
            <div className="flex flex-row items-center">
